...
/*   Updated: 2018/11/24 13:53:00 by adzikovs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
enum e_input_action	keycode_into_e_input_action(SDL_Keycode key)
{
	size_t						i;
	static char					init = 0;
	static SDL_Keycode			key_codes[WOLF3D_BUTTONS_AM];
	static enum e_input_action	action_codes[WOLF3D_BUTTONS_AM];
